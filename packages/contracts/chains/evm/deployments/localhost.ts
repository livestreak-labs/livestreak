...
export const localhostDeployment: EvmDeployOutput = {
  ...
  scopes: {
    "aa": {
      "status": "completed",
      "deployedAt": "2026-06-21T13:21:23.713Z",
      "contracts": {
    ...
    "streaming": {
      "status": "completed",
      "deployedAt": "2026-06-21T13:21:23.718Z",
      "contracts": {
    ...
    "protocol": {
      "status": "completed",
      "deployedAt": "2026-06-21T13:22:04.604Z",
      "contracts": {
    ...
    "wire": {
      "status": "completed",
      "deployedAt": "2026-06-21T13:23:30.575Z",
      "contracts": {
    ...
    "paymaster": {
      "status": "completed",
      "deployedAt": "2026-06-21T13:23:44.809Z",
      "contracts": {
