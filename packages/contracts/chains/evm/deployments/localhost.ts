...
export const localhostDeployment: EvmDeployOutput = {
  ...
  scopes: {
    "aa": {
      "status": "completed",
      "deployedAt": "2026-06-22T00:48:39.673Z",
      "contracts": {
    ...
    "streaming": {
      "status": "completed",
      "deployedAt": "2026-06-22T00:48:39.675Z",
      "contracts": {
    ...
    "protocol": {
      "status": "completed",
      "deployedAt": "2026-06-22T00:49:27.976Z",
      "contracts": {
    ...
    "wire": {
      "status": "completed",
      "deployedAt": "2026-06-22T00:50:56.405Z",
      "contracts": {
    ...
    "paymaster": {
      "status": "completed",
      "deployedAt": "2026-06-22T00:51:08.467Z",
      "contracts": {
