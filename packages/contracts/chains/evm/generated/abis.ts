...
export const marketRegistryAbi = [
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'observer', internalType: 'address', type: 'address' },
...
export const protocolAbi = [
  ...
  },
  {
    ...
    anonymous: false,
    inputs: [
      { name: 'dripsStreaming', internalType: 'address', type: 'address', indexed: true },
    ],
    name: 'DripsStreamingSet',
  },
  {
    type: 'event',
    anonymous: false,
  ...
  },
  {
    ...
    anonymous: false,
    inputs: [
      { name: 'marketRegistry', internalType: 'address', type: 'address', indexed: true },
    ],
    name: 'MarketRegistrySet',
  },
  {
    type: 'event',
    anonymous: false,
  ...
  },
  {
    ...
    anonymous: false,
    inputs: [
      { name: 'stewardRegistry', internalType: 'address', type: 'address', indexed: true },
    ],
    name: 'StewardRegistrySet',
  },
  {
    type: 'event',
    anonymous: false,
...
export const treasuryAbi = [
  ...
  },
  {
    ...
    inputs: [],
    name: 'lvstToken',
    outputs: [{ name: '', internalType: 'contract LvstToken', type: 'address' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
...
export const vaultAbi = [
  ...
  },
  {
    ...
    inputs: [],
    name: 'treasury',
    outputs: [{ name: '', internalType: 'contract ITreasurySkim', type: 'address' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  {
    type: 'error',
    inputs: [{ name: 'readyAt', internalType: 'uint256', type: 'uint256' }],
