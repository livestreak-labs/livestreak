...
export default class WalletAccountReadOnlyEvmErc4337 extends WalletAccountReadOnly {
    ...
    /**
     * Returns the account's Safe address, resolving it from the async prediction if needed.
     *
     ...
     * @returns {Promise<string>} The Safe address.
     */
    static predictSafeAddress(owner: string, config: Pick<EvmErc4337WalletConfig, "chainId" | "safeModulesVersion" | "provider"> & { contractNetworks?: Record<string, Record<string, string>>; safe4337ModuleAddress?: string; safeModulesSetupAddress?: string }): Promise<string>;
    /**
...
export type EvmErc4337WalletCommonConfig = {
    ...
    /**
     * - Custom contract addresses for unsupported chains. Keyed by chainId string.
     * Each entry should have: safeSingletonAddress, safeProxyFactoryAddress,
     * multiSendAddress, multiSendCallOnlyAddress, fallbackHandlerAddress,
     * signMessageLibAddress, createCallAddress, simulateTxAccessorAddress.
     */
    contractNetworks?: Record<string, Record<string, string>>;
    /**
     * - Override for Safe 4337 module address.
     */
    safe4337ModuleAddress?: string;
    /**
     * - Override for Safe modules setup address.
     */
