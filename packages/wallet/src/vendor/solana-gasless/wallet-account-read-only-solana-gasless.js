...
import WalletAccountReadOnlySolana from '../solana/wallet-account-read-only-solana.js'
...
/** @typedef {import('../solana/wallet-account-read-only-solana.js').SolanaTransaction} SolanaTransaction */
/** @typedef {import('../solana/wallet-account-read-only-solana.js').SolanaWalletConfig} SolanaWalletConfig */
