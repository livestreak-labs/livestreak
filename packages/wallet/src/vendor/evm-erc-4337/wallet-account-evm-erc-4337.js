...
/** @typedef {import('@safe-global/relay-kit').Safe4337Pack} Safe4337Pack */
...
export default class WalletAccountEvmErc4337 extends WalletAccountReadOnlyEvmErc4337 {
  ...
  /**
   * Returns the private key hex string for use as signer in Safe4337Pack.
   *
   * @returns {string} The private key hex.
   */
  _getSigner () {
    return '0x' + Buffer.from(this._ownerAccount.keyPair.privateKey).toString('hex')
  }
