...
const ALLOWLIST: readonly string[] = [
  ...
  "LIVESTREAK_WALRUS_REGISTRY_ID_OVERRIDE",
  "LIVESTREAK_WALRUS_CONTENT_EPHEMERAL_EPOCHS",
  "LIVESTREAK_WALRUS_CONTENT_LOCKED_EPOCHS",
  // --- Memory / wallet ---
  "LIVESTREAK_WALLET_SEED",
  "LIVESTREAK_MEMORY_OWNER_KEY",
  "LIVESTREAK_MEMORY_SUI_OWNER_KEY",
  "LIVESTREAK_MEMORY_OWNER_SEED",
  ...
  // --- TURN / WebRTC relay ---
  "LIVESTREAK_TURN_ENABLED",
  "LIVESTREAK_TURN_PORT",
  "LIVESTREAK_TURN_MIN_PORT",
  "LIVESTREAK_TURN_MAX_PORT",
  "LIVESTREAK_TURN_REALM",
  "LIVESTREAK_TURN_RELAY_IP",
  "LIVESTREAK_TURN_USER",
  "LIVESTREAK_TURN_PASS",
  // --- External services ---
  "DATABASE_URL",
  "LIVEKIT_API_KEY"
];
